    ...
    return(
        <Container>
            ...
            <h1>Registrate</h1>
                ...
                {formik.values.termsAndConditions === false ? <div className="error-message message">Debes aceptar los terminos y condiciones</div> 
                : formik.values.termsAndConditions === true && termsAndConditions.acept === false ? <div className="error-message message">Debes aceptar los terminos y condiciones</div>    
                : null}
